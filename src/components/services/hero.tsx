...
function Hero() {
  return (
    <>
      <div
        className="text-charcoal relative heroElem w-full pt-20 pb-40 m-auto flex justify-center text-center flex-col items-center z-1"
      ...
      >
        ...
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold">
          Je crée des <span className="heroShiny1 text-zomp">sites web</span> pour votre{" "}
          <span className="heroShiny2 text-zomp">entreprise... commerce... startup</span>.
          <img
