import hestauThumbnail from '/public/projects_media/hestau-festival/thumbnail.png'
import hestauTop from '/public/projects_media/hestau-festival/top-w720.png'
import hestauPartnersTop from '/public/projects_media/hestau-festival/partners-w720.png'

import mynftBridgeThumbnail from '/public/projects_media/mynft-bridge/thumbnail.png'
import mynftBridgeScreenshot from '/public/projects_media/mynft-bridge/MyNFT-Bridge-w720.png'
import mynftBridgeProgressScreenshot from '/public/projects_media/mynft-bridge/bridge-progress-w720.png'
import mynftBridgeBreadcrumbScreenshot from '/public/projects_media/mynft-bridge/mynft-bridge-breadcrumb-w720.png'
import mynftBridgeSuccessScreenshot from '/public/projects_media/mynft-bridge/mynft-bridge-mig-success-w720.png'
import mynftBridgeinputScreenshot from '/public/projects_media/mynft-bridge/mynft-bridge-input-w720.png'

import nexchangeHomepage from '/public/projects_media/nexchange/homepage-w720.png'
import nexchangeMetamask from '/public/projects_media/nexchange/metamask-w720.png'

import mintWallet from '/public/projects_media/mynft-mint/wallet-connection-w720.png'
import mintForm from '/public/projects_media/mynft-mint/form.png'

import domainTokMint from '/public/projects_media/mynft-domain-tokenization/mint-domain-w720.png'
import domainTokEditDNS from '/public/projects_media/mynft-domain-tokenization/dns-edit-w720.png'

import islaPriceScraper from '/public/projects_media/isla-price-scraper/price-scraper-w720.png'
import islaScraperResult from '/public/projects_media/isla-price-scraper/result-w720.png'

import islaPopularityScraper from '/public/projects_media/isla-popularity/vc-w720.png'
import islaPopularityScraperResult from '/public/projects_media/isla-popularity/result-w720.png'

import lbcExtractorThumbnail from '/public/projects_media/lbc-price-extension/thumbnail.png'
import lbcExtractor from '/public/projects_media/lbc-price-extension/lbc-w720side.png'
import lbcExtractorResult from '/public/projects_media/lbc-price-extension/result-small-w720.png'
...
Gist is what's displayed in the / page, in the carousel with all projects, to describe them
...
export const portfolio_proj_data = [
	{
		...
		thumbnail: {
			src: hestauThumbnail,
			alt: "Hestau festival landing page thumbnail"
		},
		screenshots: [
			{
				src: hestauTop,
	...
	{ 
		title: "Agrégateur de prix Le Bon Coin",
		project_recipient: "Projet perso",
		...
		thumbnail: {
			...
			alt: "Leboncoin price agretator project thumbnail"
		},
		screenshots: [
			{
				src: lbcExtractor,
	...
	{
		title: "Estimateur de popularité de marques",
		project_recipient: "Oly Platform",
	...
	{ 
		title: "Agrégateur de prix de marketplaces",
		project_recipient: "Oly Platform",
		gist: "Script récupérant les prix des vêtements sur des marketplaces de seconde main",
	...
	{ 
		title: "Bridge",
		project_recipient: "MyNFT",
		gist: "Application web pour transférer des NFT entre différentes blockchains",
		...
		thumbnail: {
			...
			alt: "MyNFT Bridge project thumbnail"
		},
		screenshots: [
			{
	...
	{
		title: "Noms de domaines NFT",
		project_recipient: "MyNFT",
		gist: "Application web de création et échange de nom de domaines via NFT",
	...
	{ 
		title: "Mint",
		project_recipient: "MyNFT",
		gist: "Application web génératrice de NFT",
	...
	},
	{
		title: "Nexchange",
		project_recipient: "Projet perso",
		gist: "Gestionnaire de prêt d'objets physiques via NFT",
